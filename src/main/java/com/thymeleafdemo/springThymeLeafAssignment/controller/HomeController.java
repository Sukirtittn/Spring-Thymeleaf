package com.thymeleafdemo.springThymeLeafAssignment.controller;


import com.thymeleafdemo.springThymeLeafAssignment.model.Employee;
import com.thymeleafdemo.springThymeLeafAssignment.model.ResponseDto;
import com.thymeleafdemo.springThymeLeafAssignment.service.EmployeeService;
...
public class HomeController {
    ...
    @RequestMapping("/time")
    public String alertAndTime(){
        return "serverTime";
    }



//    gor getting competency,alert and loader start stop button
    @RequestMapping("/loading-alert")
    public String loadingAlert(){
        return "loaderAndAlert";
    }
